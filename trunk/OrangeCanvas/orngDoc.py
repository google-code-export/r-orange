...
class SchemaDoc(QWidget):
    ...
    def save(self, filename = None):
        ...
        file = open('G:/Python25/Lib/site-packages/orange/OrangeWidgets/R/schema.tmp', "wt")
        file.write(xmlText)
        file.close()
        doc.unlink()
        r('save.image("G:/Python25/Lib/site-packages/orange/OrangeWidgets/R/tmp.RData")')
        
        zout = zipfile.ZipFile(filename, "w")
        for fname in ['G:/Python25/Lib/site-packages/orange/OrangeWidgets/R/schema.tmp','G:/Python25/Lib/site-packages/orange/OrangeWidgets/R/tmp.RData']:
            zout.write(fname)
        zout.close()
    ...
    def loadDocument(self, filename, caption = None, freeze = 0):
        ...
        try:
            ...
            r('load("G:/Python25/Lib/site-packages/orange/OrangeWidgets/R/tmp.RData")')
